...
class ERROR_MESSAGES(str, Enum):
    ...
    INVALID_EMAIL_FORMAT = "The email format you entered is invalid. Please double-check and make sure you're using a valid email address (e.g., first.last@attollodefense.com). Attollo personnel, please log into the Attollo Knowledge Base for access."
    INVALID_PASSWORD = (
        "The password provided is incorrect. Please check for typos and try again."
    )
    INVALID_TRUSTED_HEADER = "Your provider has not provided a trusted header. Please contact your administrator for assistance."
    INVALID_TRUSTED_MOODLE = "Invalid trusted moodle, contact LR..."
